...
const val INSERT_EXP = "InsertUserExp"
const val UPDATE_EXP = "UpdateUserExp"
const val SEARCH_EXP = "SearchUserExp"
const val GET_USER_EXP = "GetUserExp"
const val PAGE_EXP = "PageExp"
const val CURRENT_USER = "currUser"
